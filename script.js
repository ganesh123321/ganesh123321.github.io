 ...
 */
const EMAILJS_PUBLIC_KEY = 'TKjgQ9Zo65gMA3fwm';   // EmailJS public key
const EMAILJS_SERVICE_ID = 'service_w9ur3wo';   // EmailJS service ID
const EMAILJS_TEMPLATE_ID = 'template_7pwmhj5'; // EmailJS template ID
